...
public class MonteCarloAi {
    ...
    private static final Logger LOG = Logger.getLogger(MonteCarloAi.class);
    ...
    public void moveAndShoot(int player) {
        ...
        controller.addText(MOVE_FROM_TO, max.getPlayerField(), max.getMove());
        board.move(max.getPlayerField(), max.getMove());

        board.shoot(max.getShoot());
        controller.addText(SHOOT_TO, max.getShoot());
    }
